...
<title>UserCompilationConfirm画面</title>
...
<body>
	...
	<div id="main">
		<div id="top">
			<p>UserCompilationConfirm</p>
		</div>
		<div>
			<h3>更新後の内容は以下でよろしいですか。</h3>
			<table>
				<s:form action="UserCompilationCompleteAction">
					<tr id="box">
					...
					<tr id="box">
						...
						<td><s:property value="userGrade" escape="false" /></td>
					</tr>
					<tr>
